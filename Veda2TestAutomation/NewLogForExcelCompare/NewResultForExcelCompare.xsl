...
<style>
	...
	body{
	background-color: #FFFFFF;background-image:url('frugal_header.png');background-repeat:no-repeat;background-position:right top;background-size:450px 175px;;
	}*/
  ...
  <body>  
	<table align="center">
		<tr>
			...
			<img src="frugal_header.png" class="frugal"/>
  ...
  <h3 style="background:#808080;color:#FFFFFF;margin-left:12%;margin-right:12%;text-align:center"><font face="Calibri" size="4">Excel Comparision Results</font></h3>
    <table  border="1" align="center" class="maintable">
      <tr bgcolor="#9acd32" style="height:40px">
        <th align="center" width="50px"><b>Investor Names</b></th>
        <th align="center"><b>Results</b></th>
      ...
      <tr>
		...
		<td align="center" class="flip"><xsl:attribute name="id"><xsl:value-of select="$num1"/></xsl:attribute><font face="Calibri" size="2"><b><xsl:value-of select="@name"/></b></font></td>
		<xsl:choose>
	  ...
	  <table border="1" align="center" class="test" >
		  <tr bgcolor="#DCDCDC">
			<th><font face="Calibri" size="2" color="#000000">Column No</font></th>
			<th><font face="Calibri" size="2" color="#000000">Column Name</font></th>
			<th><font face="Calibri" size="2" color="#000000">VEDA2.0</font></th>
			<th><font face="Calibri" size="2" color="#000000">VEDA1.5</font></th>
			<th><font face="Calibri" size="2" color="#000000">Difference</font></th>
	   ...
	   <xsl:for-each select="Iterator/step">	
		...
		<td align="left" class="Sname"><font face="Calibri" size="2"><xsl:value-of select="stepname" /></font></td>
		<td align="center" ><font face="Calibri" size="2"><xsl:value-of select="VEDA2.0"/></font></td>
		<td align="center" ><font face="Calibri" size="2"><xsl:value-of select="VEDA1.5"/></font></td>
		<td align="center" ><font face="Calibri" size="2"><xsl:value-of select="Difference"/></font></td>
		<xsl:choose>
	...
	<table  border="1" align="center" class="maintable">
	  ...
	  <xsl:choose>
		...
		<tr>
		<td align="center"><font face="Calibri" size="2"><b><xsl:value-of select="$functionalityName"/></b></font></td>
		<td align="center" class="flip1"><xsl:attribute name="id"><xsl:value-of select="$num2"/></xsl:attribute><font face="Calibri" size="2"><b><xsl:value-of select="@name"/></b></font></td>
	  ...
	  <table border="1" align="center" class="test" >
	   ...
	   <xsl:for-each select="Iterator/step">	
		<tr>
		<td align="center" class="step" ><font face="Calibri" size="2"><xsl:value-of select="@no"/></font></td>
		<td align="center" class="Sname"><font face="Calibri" size="2"><xsl:value-of select="stepname" /></font></td>
		<td align="center" ><font face="Calibri" size="2"><xsl:value-of select="VEDA2.0"/></font></td>
		<td align="center" ><font face="Calibri" size="2"><xsl:value-of select="VEDA1.5"/></font></td>
		<td align="center" ><font face="Calibri" size="2"><xsl:value-of select="Difference"/></font></td>
		<xsl:choose>
	...
	<table  border="1" align="center" class="maintable">
	 ...
	 <table border="1" align="center" class="test" >
	   ...
	   <xsl:for-each select="Iterator/step">	
		...
		<td><font face="Calibri" size="2"><xsl:value-of select="VEDA2.0"/></font></td>
		<td><font face="Calibri" size="2"><xsl:value-of select="VEDA1.5"/></font></td>
		<td><font face="Calibri" size="2"><xsl:value-of select="Difference"/></font></td>
		<xsl:choose>
			<xsl:when test="status='Fail'">
				<td width="5%" align="center"><font face="Calibri" size="2" color="red"><b><xsl:value-of select="status"/></b></font></td>
			</xsl:when>
