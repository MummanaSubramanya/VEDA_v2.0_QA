...
public class ExchangeCheckerOperation_TS2 {
	...
	public static void vefifyCheckerOperations(){
		...
		for (int index = 1; index <= mapAllExchangeDetails.size() ; index++){
			...
			if(!bStatus){
				...
				XMLLibrary.updatedAttributeValueInCreatedXMLFile(XMLLibrary.sTradeTypeEXCNDetailsXMLFilePath, "CheckerStatus", "Fail", "TestcaseName", mapExchangeDetails.get("TestCaseName"), "TradeTypeEXCN");
				continue;
			}
			...
			if(bStatus && mapExchangeDetails.get("ExpectedResultsAfterCheckerOperations").equalsIgnoreCase("Pass")){
				...
				XMLLibrary.updatedAttributeValueInCreatedXMLFile(XMLLibrary.sTradeTypeEXCNDetailsXMLFilePath, "CheckerStatus", "Pass", "TestcaseName", mapExchangeDetails.get("TestCaseName"), "TradeTypeEXCN");
				continue;
			}
