...
public class Switch_CheckerOperations_TS2 {
	...
	public static void vefifyCheckerOperations(){
		...
		for (int index = 1; index <= mapAllSwitchDetails.size() ; index++){
			...
			if(!bStatus){
				...
				checkerStatus = "Fail";
				XMLLibrary.updatedAttributeValueInCreatedXMLFile(XMLLibrary.sTradeTypeSWITCHDetailsXMLFilePath, "CheckerStatus", checkerStatus, "TestcaseName", Reporting.Testcasename, "TradeTypeSWITCH");
				continue;
			}
