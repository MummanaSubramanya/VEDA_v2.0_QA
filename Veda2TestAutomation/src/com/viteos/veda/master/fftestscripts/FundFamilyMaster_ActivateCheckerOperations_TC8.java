...
public class FundFamilyMaster_ActivateCheckerOperations_TC8 {
	...
	public static void testCheckerOperations(){
		try{
			...
			for(int index = 1;index <= mapAllFundFamilyDetails.size();index++){
				...
				if(mapModifiedFundFamilyDetails.get("Operation").equalsIgnoreCase("Validate") || mapModifiedFundFamilyDetails.get("Operation").equalsIgnoreCase("Modify") || mapModifiedFundFamilyDetails.get("Operation").equalsIgnoreCase("DeActivate")){
					continue;
				}
				...
				if(mapModifiedFundFamilyDetails.get("Operation").equalsIgnoreCase("Activate")){
