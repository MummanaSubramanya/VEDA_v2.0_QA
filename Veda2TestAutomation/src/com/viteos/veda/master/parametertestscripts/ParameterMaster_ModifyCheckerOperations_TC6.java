...
public class ParameterMaster_ModifyCheckerOperations_TC6 {
	...
	public static void testCheckerOperations(){
		try{
			...
			for(int index = 1;index <= mapAllParameterDetails.size();index++){
				...
				if(mapModifyParameterDetails.get("Operation").equalsIgnoreCase("Validate") || mapModifyParameterDetails.get("Operation").equalsIgnoreCase("Deactivate")||mapModifyParameterDetails.get("Operation").equalsIgnoreCase("Activate")){
					continue;
				}
				...
				if(mapModifyParameterDetails.get("Operation").equalsIgnoreCase("Modify")){
					...
					if(bStatus && mapModifyParameterDetails.get("CheckerOperations").equalsIgnoreCase("Approve")){
						NewUICommonFunctions.selectMenu("Fund Setup","Parameter");
						boolean bTestStatus = TempFunctions.verifyFeeTypeDetailsScreen("Parameter Name", mapModifyParameterDetails.get("ParameterName"),"Parameter Id", mapModifyParameterDetails.get("parameterID"), "Parameter", createdParameterDetails);
						if(!bTestStatus){
				...
				if(mapModifyParameterDetails.get("CheckerOperations").equalsIgnoreCase("Approve") && bStatus){
					...
					innerMap.put("LabelValue", createdParameterDetails.get("ParameterName"));
					innerMap.put("ParameterID",createdParameterDetails.get("parameterID"));
