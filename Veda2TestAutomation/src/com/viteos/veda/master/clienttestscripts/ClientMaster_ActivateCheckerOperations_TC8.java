...
public class ClientMaster_ActivateCheckerOperations_TC8 {
	...
	public static void testCheckerOperations(){
		try{
			...
			for(int index = 1;index <= mapAllClientDetails.size();index++){
				...
				if(mapClientDetails.get("Operation").equalsIgnoreCase("Validate") || mapClientDetails.get("Operation").equalsIgnoreCase("Modify") || mapClientDetails.get("Operation").equalsIgnoreCase("DeActivate")){
					continue;
				}
				...
				if(mapClientDetails.get("Operation").equalsIgnoreCase("Activate")){
