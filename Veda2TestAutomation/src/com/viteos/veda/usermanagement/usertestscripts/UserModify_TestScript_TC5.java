...
public class UserModify_TestScript_TC5 {
	...
	public static void addUser(){
		...
		for(int index=1 ;index<=mapUserDetails.size();index++){
			...
			bStatus = NewUICommonFunctions.modifyUserManagementPortal(mapCreateuserDetails, mapCreateuserDetails.get("LoginID"), "User");
