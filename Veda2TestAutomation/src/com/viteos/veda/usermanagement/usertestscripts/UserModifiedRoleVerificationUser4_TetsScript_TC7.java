...
public class UserModifiedRoleVerificationUser4_TetsScript_TC7 {
	...
	public static void setUp(){
		...
		mapUserDetails = ExcelUtils.readDataABasedOnCellName(Global.sUserTestDataFilePath, sSheetName,"User_ModifiedRole_Assign_TC4");
	...
	public static void verifyUser1(){
			...
			bStatus = UserAppFunctios.verifyMenus(mapUserDetails);
			if(!bStatus){
